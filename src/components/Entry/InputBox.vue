...
<template>
    <div id="input-box">
        <el-form :model="inputBox" :inline="true" class="demo-form-inline" ref="inputBox" :rule="rules">
            ...
            <el-form-item  label="业务种类" prop="type">
                <el-select v-model="inputBox.type" placeholder="请选择业务种类">
                    <el-option
            ...
            <el-form-item label="金额/克数" prop="amount">
                <el-input v-model="inputBox.amount" placeholder="输入金额(万)或克数(g)"></el-input>
            </el-form-item>
        ...
        return{
            inputBox:{
                ...
                types:[
                    ...
                    {"value":"客户晋升","label":"t2"},
                    {"value":"积存金(g)","label":"t3"},
                    {"value":"中银中短债(万)","label":"t4"},
                    {"value":"新发和二发基金","label":"t5"},
                    {"value":"对私保险-折期交(万)","label":"t6"}
                ],
                orgs:[
                    {"value":"城东支行","label":"b1"},
                    {"value":"南街支行","label":"b2"},
